...
Original file is located at
    https://colab.research.google.com/drive/1UHqQweGeMaoDyR3chPUsfNScQ_SMDEqw
"""
...
def make_elasticnet_pipeline(alpha=1.0, l1_ratio=0.5, use_scaler=False):
    steps = []
    if use_scaler:
        steps.append(('scaler', StandardScaler()))
    steps.append(('enet', ElasticNet(alpha=alpha, l1_ratio=l1_ratio, random_state=42)))
    ...
    models = {
        ...
        'elasticnet': (
            make_elasticnet_pipeline(),
            {
                ...
                'use_scaler': [True, False]   # управляет стандартизацией
            }
        ),
